...
model.add(model2, mesh2, mesh3, mesh4)

// 射线投射器Raycaster
// const raycaster = new THREE.Raycaster();
// raycaster.ray.origin = new THREE.Vector3(-100, 50, 0);
// raycaster.ray.direction = new THREE.Vector3(1, 0, 0);
// // 射线发射拾取模型对象
// // .intersectObjects()和.intersectObject()功能一样,语法不同
...
//   // 选中模型的第一个模型，设置为红色
//   (intersects[0] as any).object.material.color.set(0xff0000);
// }
